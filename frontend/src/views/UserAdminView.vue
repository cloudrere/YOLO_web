<template>
  <AppLayout>
    <div class="ops-panel cols-2">
      ...
      <el-card shadow="never">
        <template #header>
          <div class="flex-between"><span>用户列表</span><el-button size="small" @click="load">刷新</el-button></div>
        </template>
...
async function create() {
  ...
  await createUser({ ...form, username, password }); Object.assign(form, { username: '', password: '', is_active: true, is_superuser: false, role_ids: [] })
