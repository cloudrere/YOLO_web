    ...
    <el-card class="login-card glass-card">
      ...
      <el-form :model="form" label-position="top" @keyup.enter="submit">
        ...
        <el-form-item :label="mode === 'reset' ? '新密码' : '密码'">
          <el-input v-model="form.password" type="password" :autocomplete="mode === 'login' ? 'current-password' : 'new-password'" size="large" show-password :placeholder="mode === 'reset' ? '请输入新密码' : '请输入密码'" />
        </el-form-item>
