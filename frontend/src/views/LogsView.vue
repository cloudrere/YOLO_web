<template>
  <AppLayout>
    <el-card shadow="never">
      <template #header>
        <div class="flex-between"><span>系统日志</span><el-button size="small" @click="load">刷新</el-button></div>
      </template>
      <div class="ops-filter-row">
        ...
        <el-input v-model="filters.log_type" clearable placeholder="日志类型" style="width:140px" />
        <el-date-picker v-model="dateRange" type="daterange" value-format="YYYY-MM-DD HH:mm:ss" start-placeholder="开始日期" end-placeholder="结束日期" size="small" />
